...
- **E0-E1 interface document** (the interface as understood in 2026; input to the September 2026 Streaming Computing Model formalization): <https://github.com/BNLNPPS/swf-testbed/blob/main/docs/e0-e1-interface.md>
